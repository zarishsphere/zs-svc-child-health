...
git clone https://github.com/zarishsphere/zs-svc-child-health.git
cd zs-svc-child-health
...
See [docs.zarishsphere.com/api/zs-svc-child-health](https://docs.zarishsphere.com/api/zs-svc-child-health) for the full OpenAPI 3.1 specification.
